...
class ProductHelper
{
    ...
    public static function generateAttributes(array $dataArray): array
    {
        $attributes = [];
        foreach ($dataArray as $item) {
            ...
            foreach ($item['values'] as $key => $value) {
                if ($key !== 0) {
                    $options_string .= " " . self::WC_DELIMITER . " ";
                }
...
//    public static function defineStatus(int $statusCode): string
//    {
